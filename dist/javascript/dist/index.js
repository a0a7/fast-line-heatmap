...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('fastgeotoolkit_bg.wasm', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.js', document.baseURI).href)));
    }
    const imports = __wbg_get_imports();
...
exports.calculateTrackStatistics = calculateTrackStatistics;
exports.coordinatesToGeojson = coordinatesToGeojson;
exports.decodePolyline = decodePolyline;
exports.exportToGpx = exportToGpx;
exports.findTrackIntersections = findTrackIntersections;
exports.getFileInfo = getFileInfo;
exports.init = init;
exports.processGpxFiles = processGpxFiles;
exports.processPolylines = processPolylines;
