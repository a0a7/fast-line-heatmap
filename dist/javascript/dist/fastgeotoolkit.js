 ...
 * @returns {any}
 */
export function decode_polyline_string(encoded) {
 ...
 * @returns {any}
 */
export function process_polylines(polylines) {
 ...
 * @returns {any}
 */
export function process_gpx_files(files) {
 ...
 * @returns {any}
 */
export function validate_coordinates(coords) {
 ...
 * @returns {any}
 */
export function filter_coordinates_by_bounds(coords, bounds) {
 ...
 * @returns {any}
 */
export function calculate_track_statistics(coords) {
 ...
 * @returns {any}
 */
export function simplify_coordinates(coords, tolerance) {
 ...
 * @returns {any}
 */
export function merge_nearby_tracks(tracks, distance_threshold) {
 ...
 * @returns {any}
 */
export function split_track_by_gaps(coords, max_gap_km, _max_time_gap_seconds) {
 ...
 * @returns {string}
 */
export function coordinates_to_polyline(coords) {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {any}
 */
export function coordinates_to_geojson(coords, properties) {
 ...
 * @returns {string}
 */
export function export_to_gpx(tracks, _metadata) {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {any}
 */
export function find_track_intersections(tracks, tolerance) {
 ...
 * @returns {any}
 */
export function calculate_coverage_area(tracks) {
 ...
 * @returns {any}
 */
export function cluster_tracks_by_similarity(tracks, similarity_threshold) {
 ...
 * @returns {any}
 */
export function get_bounding_box(coords) {
 ...
 * @returns {any}
 */
export function resample_track(coords, target_point_count) {
 ...
 * @returns {any}
 */
export function get_file_info(file_bytes) {
 ...
 * @returns {any}
 */
export function extract_file_metadata(file_bytes) {
